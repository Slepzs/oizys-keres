...
export const HERBLORE_RECIPES: Record<HerbloreRecipeId, HerbloreRecipe> = {
  brew_attack_potion: {
    ...
    name: 'Attack Potion',
    icon: '⚗️',
    description: 'Brew a Guam herb into an Attack Potion (+15 attack for 5 min).',
  ...
  brew_defence_potion: {
    ...
    name: 'Defence Potion',
    icon: '🛡️',
    description: 'Brew a Marrentill herb into a Defence Potion (+15 defence for 5 min).',
  ...
  brew_strength_potion: {
    ...
    icon: '💪',
    description: 'Brew a Tarromin herb into a Strength Potion (+15 strength for 5 min).',
  ...
  brew_super_attack_potion: {
    ...
    icon: '⚗️',
    description: 'Brew a Harralander herb into a Super Attack Potion (+30 attack for 5 min).',
  ...
  brew_super_strength_potion: {
    ...
    icon: '💪',
    description: 'Brew a Ranarr herb into a Super Strength Potion (+30 strength for 5 min).',
