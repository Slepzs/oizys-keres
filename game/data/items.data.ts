...
export const ITEM_DEFINITIONS: Record<ItemId, ItemDefinition | EquipmentDefinition | FoodDefinition | PotionDefinition> = {
  ...
  attack_potion: {
    id: 'attack_potion',
    name: 'Attack Potion',
    description: 'Temporarily boosts attack by +6 for 5 minutes.',
    icon: '⚗️',
    category: 'potion',
    rarity: 'common',
    maxStack: 50,
  ...
  defence_potion: {
    id: 'defence_potion',
    name: 'Defence Potion',
    description: 'Temporarily boosts defence by +6 for 5 minutes.',
    icon: '🛡️',
    category: 'potion',
    rarity: 'uncommon',
    maxStack: 50,
  ...
  strength_potion: {
    ...
    description: 'Temporarily boosts strength by +6 for 5 minutes.',
    icon: '💪',
    category: 'potion',
    rarity: 'uncommon',
    maxStack: 50,
  ...
  super_attack_potion: {
    ...
    description: 'Greatly boosts attack by +12 for 5 minutes.',
    icon: '⚗️',
    category: 'potion',
    rarity: 'rare',
    maxStack: 50,
  ...
  super_strength_potion: {
    ...
    description: 'Greatly boosts strength by +12 for 5 minutes.',
    icon: '💪',
    category: 'potion',
    rarity: 'rare',
    maxStack: 50,
