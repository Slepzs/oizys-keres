...
export const INFRASTRUCTURE_DEFINITIONS: Record<InfrastructureId, InfrastructureDefinition> = {
  ...
  forge: {
    id: 'forge',
    name: 'Master Forge',
    description: 'A high-temperature forge built from rare metals that amplifies mining and crafting output.',
    icon: 'anvil',
    fallbackIcon: '🔨',
    maxLevel: 1,
    bonuses: [
      { target: 'mining', type: 'additive', value: 0.15 },
      { target: 'crafting', type: 'additive', value: 0.15 },
    ],
  },
};
...
export const CRAFTING_RECIPES: Record<CraftingRecipeId, CraftingRecipe> = {
  ...
  craft_mithril_sword: {
    ...
    requirements: [
      ...
      { type: 'skill_level', skillId: 'mining', level: 55 },
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 220 },
  ...
  craft_rune_sword: {
    ...
    requirements: [
      ...
      { type: 'skill_level', skillId: 'mining', level: 60 },
      { type: 'infrastructure_level', infrastructureId: 'armory', level: 1 },
    ],
    costs: [
      { type: 'resource', resourceId: 'yew_wood', amount: 220 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 380 },
  ...
  craft_elderwood_blade: {
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'iron_ore', amount: 280 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 180 },
  ...
  craft_arcane_warblade: {
    ...
    requirements: [
      ...
      { type: 'skill_level', skillId: 'mining', level: 65 },
      { type: 'skill_level', skillId: 'crafting', level: 35 },
      { type: 'infrastructure_level', infrastructureId: 'armory', level: 1 },
    ],
    costs: [
      { type: 'resource', resourceId: 'yew_wood', amount: 320 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 360 },
      { type: 'resource', resourceId: 'adamantite_ore', amount: 160 },
  ...
  craft_mithril_helmet: {
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 140 },
  ...
  craft_mithril_boots: {
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 120 },
  ...
  craft_runic_helmet: {
    ...
    costs: [
      { type: 'resource', resourceId: 'yew_wood', amount: 130 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 240 },
  ...
  craft_runic_chestplate: {
    ...
    requirements: [
      ...
      { type: 'skill_level', skillId: 'mining', level: 62 },
      { type: 'skill_level', skillId: 'crafting', level: 22 },
      { type: 'infrastructure_level', infrastructureId: 'armory', level: 1 },
    ],
    costs: [
      { type: 'resource', resourceId: 'yew_wood', amount: 200 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 320 },
  ...
  craft_runic_platelegs: {
    ...
    requirements: [
      ...
      { type: 'skill_level', skillId: 'mining', level: 61 },
      { type: 'skill_level', skillId: 'crafting', level: 21 },
      { type: 'infrastructure_level', infrastructureId: 'armory', level: 1 },
    ],
    costs: [
      { type: 'resource', resourceId: 'yew_wood', amount: 170 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 290 },
      { type: 'item', itemId: 'sapphire', amount: 3 },
  ...
  craft_runic_boots: {
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 190 },
  ...
  craft_arcane_helmet: {
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 180 },
      { type: 'resource', resourceId: 'adamantite_ore', amount: 80 },
  ...
  craft_arcane_chestplate: {
    ...
    requirements: [
      ...
      { type: 'skill_level', skillId: 'mining', level: 67 },
      { type: 'skill_level', skillId: 'crafting', level: 33 },
      { type: 'infrastructure_level', infrastructureId: 'armory', level: 1 },
    ],
    costs: [
      { type: 'resource', resourceId: 'yew_wood', amount: 240 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 280 },
      { type: 'resource', resourceId: 'adamantite_ore', amount: 120 },
      { type: 'resource', resourceId: 'coal', amount: 340 },
  ...
  craft_arcane_platelegs: {
    ...
    requirements: [
      { type: 'skill_level', skillId: 'woodcutting', level: 68 },
      { type: 'skill_level', skillId: 'mining', level: 66 },
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 240 },
      { type: 'resource', resourceId: 'adamantite_ore', amount: 100 },
  ...
  craft_arcane_boots: {
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 160 },
      { type: 'resource', resourceId: 'adamantite_ore', amount: 70 },
  ...
  craft_berserker_charm: {
    ...
    costs: [
      ...
      { type: 'resource', resourceId: 'mithril_ore', amount: 200 },
      { type: 'resource', resourceId: 'coal', amount: 200 },
  ...
  build_forge: {
    id: 'build_forge',
    name: 'Build Master Forge',
    description: 'Adds a permanent +15% mining XP and +15% crafting XP bonus.',
    icon: 'anvil',
    fallbackIcon: '🔨',
    category: 'infrastructure',
    requirements: [
      { type: 'skill_level', skillId: 'woodcutting', level: 55 },
      { type: 'skill_level', skillId: 'mining', level: 60 },
      { type: 'skill_level', skillId: 'crafting', level: 35 },
      { type: 'infrastructure_level', infrastructureId: 'armory', level: 1 },
    ],
    costs: [
      { type: 'resource', resourceId: 'yew_wood', amount: 240 },
      { type: 'resource', resourceId: 'mithril_ore', amount: 600 },
      { type: 'resource', resourceId: 'adamantite_ore', amount: 200 },
      { type: 'resource', resourceId: 'coal', amount: 480 },
    ],
    output: { type: 'infrastructure', infrastructureId: 'forge', levels: 1 },
    repeatable: false,
  },
};
